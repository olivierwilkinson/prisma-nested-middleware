...
describe("calls", () => {
  ...
  it.each<{
    ...
    {
      description: "deeply nested nested createMany",
      rootParams: createParams("User", "update", {
        where: { id: faker.datatype.number() },
        data: {
          email: faker.internet.email(),
    ...
    {
      description: "deeply nested nested updateMany",
      rootParams: createParams("User", "update", {
        where: { id: faker.datatype.number() },
        data: {
          email: faker.internet.email(),
    ...
    {
      description: "deeply nested nested deleteMany",
      rootParams: createParams("User", "update", {
        where: { id: faker.datatype.number() },
        data: {
          email: faker.internet.email(),
    ...
    {
      description: "deeply nested nested connectOrCreate",
      rootParams: createParams("User", "update", {
        where: { id: faker.datatype.number() },
        data: {
          email: faker.internet.email(),
